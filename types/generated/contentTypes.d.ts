...
export interface ApiConsultaConsulta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivo_adjunto: Schema.Attribute.Media<
    ...
    estudios_recomendados: Schema.Attribute.String;
    fecha_consulta: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    medico: Schema.Attribute.Relation<'manyToOne', 'api::medico.medico'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    receta: Schema.Attribute.String;
    tipo_consulta: Schema.Attribute.Enumeration<
...
export interface ApiMedicoMedico extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    anios_experiencia: Schema.Attribute.Integer;
    apellidos: Schema.Attribute.String;
    cedula_profesional: Schema.Attribute.String;
    consultas: Schema.Attribute.Relation<'oneToMany', 'api::consulta.consulta'>;
    correo_profesional: Schema.Attribute.Email;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curp: Schema.Attribute.String;
    direccion_consultorio: Schema.Attribute.String;
    especialidad: Schema.Attribute.String;
    estudios: Schema.Attribute.Relation<'oneToMany', 'api::estudio.estudio'>;
    foto_perfil: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    institucion_actual: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::medico.medico'
    > &
      Schema.Attribute.Private;
    matricula_sanitaria: Schema.Attribute.String;
...
export interface ApiPacientePaciente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acepta_compartir_datos: Schema.Attribute.Boolean;
    alergias: Schema.Attribute.String;
    antecedentes_familiares: Schema.Attribute.String;
    apellidos: Schema.Attribute.String;
    consultas: Schema.Attribute.Relation<'oneToMany', 'api::consulta.consulta'>;
    contacto_emergencia: Schema.Attribute.String;
    ...
    discapacidad: Schema.Attribute.String;
    ...
    foto: Schema.Attribute.Media<
      ...
      true
    >;
    genero: Schema.Attribute.Enumeration<['Masculino', 'Femenino', 'Otro']>;
    hospital_preferencia: Schema.Attribute.String;
    intervenciones_previas: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    medicamentos_actuales: Schema.Attribute.String;
    medico_cabecera: Schema.Attribute.String;
    nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    qraccesses: Schema.Attribute.Relation<
      'oneToMany',
      'api::qraccess.qraccess'
    >;
    telefono_contacto: Schema.Attribute.String;
    tipo_sangre: Schema.Attribute.String;
    ultima_consulta: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    vacunas: Schema.Attribute.Relation<'oneToMany', 'api::vacuna.vacuna'>;
  };
}

export interface ApiQraccessQraccess extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    codigo: Schema.Attribute.Integer & Schema.Attribute.Unique;
    confirmado: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiracion: Schema.Attribute.DateTime;
    expirado: Schema.Attribute.Boolean;
...
export interface ApiVacunaVacuna extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dosis: Schema.Attribute.Enumeration<
      [
        'Primera dosis',
        'Segunda dosis',
        'Tercera dosis',
    ...
    paciente: Schema.Attribute.Relation<'manyToOne', 'api::paciente.paciente'>;
    publishedAt: Schema.Attribute.DateTime;
    sitio_aplicacion: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    via_administracion: Schema.Attribute.Enumeration<
      [
        'Intramuscular',
        'Subcut\u00E1nea',
        'Intrad\u00E9rmica',
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    medico: Schema.Attribute.Relation<'oneToOne', 'api::medico.medico'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::qraccess.qraccess': ApiQraccessQraccess;
      'api::vacuna.vacuna': ApiVacunaVacuna;
